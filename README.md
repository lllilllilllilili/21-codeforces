...
> - [행렬 테두리 회전하기](./algorithm/구현/행렬테두리회전하기/행렬테두리회전하기.java) | 프로그래머스 | Java | 방향에 따라 DFS 로 맵의 값을 갱신하여 문제를 해결할 수 있습니다. 
> - [로또의 최고 순위와 최저 순위](./algorithm/구현/로또/로또의최고순위와최저순위.java) | 프로그래머스 | Java | 
> - [신규아이디추천](./algorithm/구현/신규아이디추천/신규아이디추천.java) | 프로그래머스 | Java | 
> - [줄서기](./algorithm/구현/줄서기/BOJ_14864_줄서기.java) | 백준 | Java | 규칙을 찾아서 문제를 해결하는것이 포인트!, ad-hoc 이란 무엇인지 느낄 수 있습니다. 
...
> - [녹색 옷입은 애가 젤다지?](./algorithm/다익스트라/BOJ_4485_녹색옷입은애가젤다지.java) | 백준 | Java | 
...
> - [현욱은괄호왕이야!!](./algorithm/스택/현욱은괄호왕이야.java) | Stack과 array를 이용해서 ( ) 정상적인 괄호에 대해서 array에 1로 표시한 뒤 연속된 값에 대해 최대값을 갱신해주면 해결할 수 있습니다. 
> - [짝지어제거하기](./algorithm/스택/짝지어제거하기.java) | 프로그래머스 | Java | 스택을 활용하면 쉽게 해결할 수 있습니다.
